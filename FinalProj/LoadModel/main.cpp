...
#include "../my_class/shader_m.h"
#include "../my_class/camera.h"
#include "../my_class/model.h"
...
int main()
{
	...
	// -------------------------
	Shader ourShader("../resource/shader/1.model_loading.vs", "../resource/shader/1.model_loading.fs");
